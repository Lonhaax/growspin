...
function GameChart({ phase, multiplier, elapsedTime, countdown }) {
    ...
    return (
        <div className="chart-container-antd" style={{ position: 'relative' }}>
            ...
            <img
                ref={rocketRef}
                src="https://static.wikia.nocookie.net/growtopia/images/8/8f/ItemSprites.png/revision/latest/window-crop/width/32/x-offset/2016/y-offset/160/window-width/32/window-height/32?format=webp&fill=cb-20260219100732"
                alt="Rocket"
